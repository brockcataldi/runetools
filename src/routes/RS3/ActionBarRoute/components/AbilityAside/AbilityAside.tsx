...
import { Wrapper, Header, Title } from './AbilityAside.elements'
...
interface IAbilityAsideProps {
    slotsRef: RefObject<ISlotValue[][]>
    setSlots: (slots: ISlotValue[][]) => void
}

const AbilityAside = ({ slotsRef, setSlots }: IAbilityAsideProps) => {
