...
const Wrapper = styled.a<IWrapperProps>`
    ...
    ${({ $background, $style }) => {
        if ($style === 'rs3') {
            ...
            switch ($background) {
                case 'dark':
                    return 'background-color: var(--osrs-color-background-30);'
                case 'light':
                    return 'background-color: var(--osrs-color-background-70);'
                default:
                    return 'background-color: var(--osrs-color-background-50);'
            }
        }
    }}
